...
public class CustomWeekBar extends WeekBar {
    ...
    public CustomWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.attend_custom_week_bar, this, true);
        setBackgroundColor(0xff0084ff);
        setPadding(dipToPx(getContext(),40f),dipToPx(getContext(),0f),dipToPx(getContext(),40f),dipToPx(getContext(),0f));
    }
