                ...
                when (operateType) {
                    "ADD" -> {
                        trackHttpPresenter?.addAttendManage(
                                ...
                                if (attendTimes == FOUR_TIMES) getSecond(tv_sign_time_afternoon_on.text.toString()) else null,
                                if (attendTimes == FOUR_TIMES) getSecond(tv_sign_time_afternoon_off.text.toString()) else null,
