package com.xwjr.track.attend.util;
...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(TrackConfig.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(TrackConfig.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        try {
            ...
            sToast = Toast.makeText(TrackConfig.getContext(), text, duration);
            sToast.show();
        } catch (Exception e) {
            try {
                Looper.prepare();
